...
INSERT INTO "new_User" ("clientId", "createdAt", "email", "id", "isAdmin", "lastLoginAt", "name", "passwordHash", "role") SELECT "clientId", "createdAt", "email", "id", "isAdmin", "lastLoginAt", "name", "passwordHash", "role" FROM "User";
DROP TABLE "User";
