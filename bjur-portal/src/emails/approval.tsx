...
<div style="background:#eeebe5;padding:44px 20px">
  ...
  <div style="max-width:600px;margin:0 auto;background:#f6f4f0;border:1px solid #dcd8d1">
    ...
    <div style="padding:26px 40px;border-bottom:1px solid #dcd8d1">
    ...
    <div style="padding:36px 40px 24px">
      ...
      <h1 style="font-family:Georgia,'Times New Roman',serif;font-size:30px;line-height:1.1;font-weight:400;color:#17161a;margin:0 0 14px">${esc(headline)}</h1>
      <p style="font-size:15px;line-height:1.65;color:#4a4844;margin:0">
        Hi ${esc(recipientName)} — this is scheduled to go out on your channels. Approve it, or hold it if it needs a change.
      </p>
    </div>

    <div style="padding:0 40px 8px">
      <div style="border:1px solid #dcd8d1;padding:20px">
        <div style="font-size:17px;font-weight:800;color:#17161a;line-height:1.3">${esc(title)}</div>
        <div style="font-size:12px;color:#6e6b66;margin-top:6px">${esc(projectTitle)} · ${esc(platforms)} · ${esc(publishAtLabel)}</div>
        ${
          caption
            ? `<div style="font-size:14px;line-height:1.6;color:#4a4844;margin-top:14px;padding-left:12px;border-left:2px solid #dcd8d1">${esc(
                caption.slice(0, 500)
              )}</div>`
            : `<div style="font-size:13px;color:#6e6b66;margin-top:14px">No caption written yet.</div>`
        }
      </div>
    </div>
      ...
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" class="stack" style="width:100%">
        <tr>
          <td style="padding-right:10px" class="btn">
            <a href="${approveUrl}" style="display:block;text-align:center;background:#ec3013;color:#f6f4f0;font-size:14px;font-weight:800;text-decoration:none;padding:14px 18px">Approve</a>
          </td>
          <td class="btn">
            <a href="${holdUrl}" style="display:block;text-align:center;background:#eeebe5;border:1px solid #3a3a40;color:#17161a;font-size:14px;font-weight:700;text-decoration:none;padding:13px 18px">Hold it</a>
          </td>
        </tr>
      </table>
      <p style="font-size:12px;line-height:1.6;color:#6e6b66;margin:14px 0 0">
    ...
    <div style="padding:26px 40px 32px">
      <div style="border-top:1px solid #dcd8d1;padding-top:16px;font-size:11px;line-height:1.6;color:#8a877f">
