        ...
        >
          {!result ? (
            ...
            <>
              ...
              <div className="text-[13px] text-muted mb-6">
                Point HandBrake&apos;s and your image editor&apos;s export
                destination at this folder — anything dropped there is
                auto-organized and appears in the client&apos;s gallery.
              </div>
